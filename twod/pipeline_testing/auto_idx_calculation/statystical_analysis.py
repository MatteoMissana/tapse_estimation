...
def analysis(manual_path, automatic_path, patient_ids, save_path=None, non_parametric=False):
    ...
    for col in index_columns:
        ...
        plt.text(mean.min(), loa_upper, upper_label, color='red', va='bottom', ha='left', fontsize=8)
        plt.text(mean.min(), loa_lower, lower_label, color='red', va='top', ha='left', fontsize=8)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--non_parametric", action="store_true", help="Calculate median and 5-95 percentiles")
    ...
    analysis(manual_path, args.automatic_path, patient_ids, save_path, non_parametric=args.non_parametric)