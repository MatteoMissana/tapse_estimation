...
from temporal_pipeline.dataloader.data_prep import RandomClipDataset_v
...
# load the test_set in 3d images of 32 frames (TODO: needs to be changed so that the images are always the same)
test_dataset = RandomClipDataset_v(test_path, clip_length=32)
test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False)

#path to the modelweights
model_checkpoint = "runs/unet16_augmentation/best_model.pth"

# path where to save the predictions
img_path = "runs/unet16_augmentation/"
